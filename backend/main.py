...
■ 길이: 1,200~1,800자
■ 금지: 딱딱한 보고서 문체, 과도한 전문용어, 근거 없는 수치, 단어의 뜻을 유추하여 SF 소설처럼 허구의 사실을 지어내는 행위(할루시네이션)
■ 주의 사항: 제시된 키워드가 최신 IT/소프트웨어/AI 기술일 경우, 물리적 기계나 장비로 착각하지 말고 철저히 '소프트웨어 및 IT 서비스' 관점에서 경험을 바탕으로 서술하세요.
